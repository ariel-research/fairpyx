...
class TestSantaClausAlgorithm(unittest.TestCase):
    ...
    def test_min_value_comparison_47705(self):
        """
        Compare the minimum positive share each player receives between
        ...
        items = [f"c{j}" for j in range(1, n_items + 1)]
        valuations = {
            'Player_1': {'c1': 4, 'c2': 4, 'c3': 7, 'c4': 6, 'c5': 6, 'c6': 1, 'c7': 10, 'c8': 7, 'c9': 9, 'c10': 9, 'c11': 2, 'c12': 10}, 
            'Player_2': {'c1': 4, 'c2': 4, 'c3': 7, 'c4': 6, 'c5': 0, 'c6': 1, 'c7': 10, 'c8': 7, 'c9': 9, 'c10': 9, 'c11': 2, 'c12': 10}, 
            'Player_3': {'c1': 4, 'c2': 0, 'c3': 0, 'c4': 6, 'c5': 6, 'c6': 1, 'c7': 10, 'c8': 0, 'c9': 0, 'c10': 0, 'c11': 0, 'c12': 0}, 
            'Player_4': {'c1': 4, 'c2': 4, 'c3': 7, 'c4': 6, 'c5': 6, 'c6': 0, 'c7': 0, 'c8': 7, 'c9': 9, 'c10': 9, 'c11': 2, 'c12': 10}, 
            'Player_5': {'c1': 0, 'c2': 4, 'c3': 7, 'c4': 6, 'c5': 0, 'c6': 0, 'c7': 0, 'c8': 0, 'c9': 0, 'c10': 0, 'c11': 0, 'c12': 10}, 
            'Player_6': {'c1': 4, 'c2': 4, 'c3': 7, 'c4': 0, 'c5': 6, 'c6': 1, 'c7': 10, 'c8': 7, 'c9': 9, 'c10': 0, 'c11': 2, 'c12': 10}, 
            'Player_7': {'c1': 0, 'c2': 0, 'c3': 7, 'c4': 0, 'c5': 0, 'c6': 0, 'c7': 0, 'c8': 0, 'c9': 0, 'c10': 0, 'c11': 2, 'c12': 0}, 
            'Player_8': {'c1': 0, 'c2': 0, 'c3': 7, 'c4': 6, 'c5': 6, 'c6': 1, 'c7': 10, 'c8': 7, 'c9': 0, 'c10': 9, 'c11': 2, 'c12': 10}}
        agent_caps = {p: n_items for p in players}
        item_caps = {i: 1 for i in items}
        ...
        print(f"santa_alloc={santa_alloc}")
        rr_alloc = fairpyx.divide(
            algorithm=fairpyx.algorithms.round_robin,
            instance=instance
        )
...
if __name__ == "__main__":
    ...
    result = TestSantaClausAlgorithm().test_min_value_comparison_47705()
