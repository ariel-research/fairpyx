...
import numpy as np
from fairpyx import Instance, AgentBundleValueMatrix, validate_allocation, allocation_is_fractional, AllocationBuilder, ExplanationLogger
...
def divide(
    ...
    **kwargs
    ...
    >>> divide(algorithm=round_robin, agent_capacities=agent_capacities, item_capacities=item_capacities, valuations=valuations)
    {'Alice': ['c1', 'c3'], 'Bob': ['c2']}
    """
    if instance is None:
...
def divide_with_priorities(
    ...
    **kwargs
    ...
    >>> divide_with_priorities(round_robin, instance=instance, agent_priority_classes=[["Alice","Bob"]])
    {'Alice': ['c1', 'c3'], 'Bob': ['c2']}
    >>> divide_with_priorities(round_robin, instance=instance, agent_priority_classes=[["Alice"],["Bob"]]) # Alice has priority
    {'Alice': ['c2', 'c3'], 'Bob': ['c1']}
    >>> divide_with_priorities(round_robin, instance=instance, agent_priority_classes=[["Bob"],["Alice"]]) # Bob has priority
    {'Alice': ['c1', 'c2'], 'Bob': ['c3']}
    """
    if instance is None:
...
if __name__ == "__main__":
    ...
    #     fairpyx.round_robin, num_of_agents=70, num_of_items=10, agent_capacity_bounds=[6,6], item_capacity_bounds=[40,40], 
