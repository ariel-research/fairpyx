...
def experiment1(equal_capacities: bool, category_count: int, item_capacity_bounds: any, random_seed_num: int,
    ...
    instance, agent_category_capacities, categories, initial_agent_order = random_instance(
        ...
        item_capacity_bounds=item_capacity_bounds, random_seed_num=random_seed_num,num_of_agents=num_of_agents)
...
#     'category_count': range(2000,2005),
...
# experiments_csv.single_plot_results('results/experiment3.csv',filter={},x_field='category_count',y_field='runtime',z_field='algorithm',save_to_file='results/experiment3.png')
#
#
